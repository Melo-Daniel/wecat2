                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                ...
                                <tbody>
                                  <?php
                                  $p = new Produto();
                                    foreach ($p->listarProdutosCategoria($_SESSION['usr'],$categoria) as $key => $value) {
                                      ?>


                                <tr>
                                    <td>
                                       <?php echo $value->pro_nome ?>
                                    </td>
                                    <td>
                                        <?php echo $value->pro_codigo ?>
                                    </td>
                                    <td>
                                        <?php echo $value->pro_detalhes ?>
                                    </td>
                                    <td>
                                        <?php echo $value->pro_preco ?>
                                    </td>
